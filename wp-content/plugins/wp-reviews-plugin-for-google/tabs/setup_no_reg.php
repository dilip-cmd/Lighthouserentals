...
<?php if(TrustindexPlugin::$widget_templates[ 'templates' ][ $style_id ]['type'] != 'badge'): ?>
...
<?php endif; ?>
<?php if(TrustindexPlugin::$widget_templates[ 'templates' ][ $style_id ]['type'] != 'badge' && !in_array($style_id, [8, 9, 10, 18, 16, 17, 21, 23, 30, 31, 32, 33])): ?>
<span class="ti-checkbox row">
...
<?php if(!in_array(TrustindexPlugin::$widget_templates[ 'templates' ][ $style_id ]['type'], [ 'badge', 'button' ])): ?>
<span class="ti-checkbox row">
