...
?>
	...
	<?php ob_start(); ?>
		<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			...
			?>
				<div id="et-top-navigation" data-height="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>" data-fixed-height="<?php echo esc_attr( et_get_option( 'minimized_menu_height', '40' ) ); ?>">
					...
					<div class="headerlink">
			          ...
			          ?>
			            ...
			            <div class="sm-cart-wrapper">
			              <a class="sm-cart">
			                <?php echo $icon; ?>
			               
			                <img src="<?php echo get_stylesheet_directory_uri(); ?>/image/ic2.png" width="30" height="26" alt="" />
			                <span class="sm-count"><?php echo $woocommerce->cart->cart_contents_count; ?></span>
			              </a>
				...
				<div class="search_div container">
	                <?php if ( 'fullscreen' !== et_get_option( 'header_style', 'left' ) ) { ?>
	                    <div class="clear"></div>
	                <?php } ?>
	                <form role="search" method="get" class="et-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	?>
		<div id="et-main-area" class="arch_product_side">
	<?php
		/**
