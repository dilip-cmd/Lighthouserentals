...
return array (
 ...
 5 => 'review-widgets-for-amazon',
 6 => 'review-widgets-for-arukereso',
 7 => 'review-widgets-for-airbnb',
 8 => 'review-widgets-for-hotels-com',
 9 => 'review-widgets-for-opentable',
 10 => 'review-widgets-for-foursquare',
 11 => 'review-widgets-for-bookatable',
 ...
 19 => 'widgets-for-alibaba-reviews',
);
}
...
$chosed_platform = new TrustindexPlugin($force_platform, __FILE__, "do-not-care-6.5", "do-not-care-Widgets for Google Reviews", "do-not-care-Google");
...
{
$array['content'] = preg_replace('/<div class="ti-header source-.*<\/div>\s?<div class="ti-reviews-container pg">/mU', '<div class="ti-reviews-container pg">', $array['content']);
}
...
if($widget_css)
{
echo '<style type="text/css">'. $widget_css .'</style>';
}
}
}
