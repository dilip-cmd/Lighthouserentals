...
if (isset($_POST['wp_autosearch_submit']) && $is_secure) {
    ...
    if(isset($_POST['excluded_cats'])){
        $catsID = $_POST['excluded_cats'];
    }else{
        $catsID ='';
    }
    ...
    $wp_autosearch['excluded_cats'] = $wizardinfosys_autosearch->helper->wi_prepare_parameter(explode(',',$catsID), true);
    ...
    if(isset($_POST['search_image'])){
        $sai = $_POST['search_image'];
    }else{
        $sai ='';
    }

    $wp_autosearch['search_image'] = $wizardinfosys_autosearch->helper->wi_prepare_parameter($sai, false);
